...
Puedes registrar más desde "Nuevo momento"</p>
      </div>;
  }
  return <div ref={ref} className="py-6">
      {isLoadingMore ? <div className="space-y-4">
          {/* Skeleton loading para momentos */}
          {[...Array(3)].map((_, i) => <div key={i} className="bg-card rounded-xl p-6 border border-sage-200/30">
          ...
          <Button onClick={onLoadMore} variant="outline" className="border-sage-200 text-sage-600 hover:bg-sage-50" disabled={!hasNextPage}>
