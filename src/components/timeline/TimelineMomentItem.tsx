    ...
    <div className="relative">
      ...
      >
        <div className="p-4 sm:p-6">
          ...
          {moment.is_featured && (
            <div className="absolute top-2 right-2 w-6 h-6 bg-gradient-to-br from-amber-400 to-amber-500 rounded-full flex items-center justify-center featured-star shadow-lg z-10">
