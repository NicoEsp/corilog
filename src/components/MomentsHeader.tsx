...
const MomentsHeader = ({
  ...
  return <div className="mb-6 sm:mb-8 text-center">
      <h2 className="text-xl sm:text-2xl font-serif-elegant text-sage-800 mb-2">Momentos guardados</h2>
      ...
      <div className="flex justify-center gap-2 flex-wrap">
        ...
        <PremiumFeatureButtons onPremiumFeatureClick={onPremiumFeatureClick} />
      </div>
    </div>;
};
